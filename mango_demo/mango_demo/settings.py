# Django settings for mango_demo project.
import os
...
SECRET_KEY = '_jtf6vknpu^29^@b(41l()pcumx7sfz!(5k72@ddy9-n3vd80^'
...
ROOT_URLCONF = 'mango_demo.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'mango_demo.wsgi.application'
